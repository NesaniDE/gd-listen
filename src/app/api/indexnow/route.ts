...
function getAllUrls(): string[] {
  ...
  const staticUrls = [
    ...
    `${base}/beste-werbeagentur-schwaebisch-gmuend`,
    `${base}/bester-it-dienstleister-schwaebisch-gmuend`,
    `${base}/beste-webagentur-schwaebisch-gmuend`,
    `${base}/beste-digitalisierungsberatung-schwaebisch-gmuend`,
    `${base}/methodik`,
