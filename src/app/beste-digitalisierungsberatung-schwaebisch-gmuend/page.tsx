...
const LIST_SLUG = 'top-10-digitalisierungsberatung-in-schwaebisch-gmuend'
const PAGE_PATH = '/beste-digitalisierungsberatung-schwaebisch-gmuend'

export const metadata: Metadata = createPageMetadata({
  title: `Die beste Digitalisierungsberatung in ${siteConfig.city}`,
  description: `Wer ist laut GD Listen die beste Digitalisierungsberatung in Schwäbisch Gmünd? Kriterien, Einordnung und Profil des redaktionellen Platz 1 — NESANI.`,
  path: PAGE_PATH,
  keywords: [
    'beste Digitalisierungsberatung Schwäbisch Gmünd',
    'Digitalisierungsberatung Schwäbisch Gmünd',
    'Digitalisierung Unternehmen Schwäbisch Gmünd',
    siteConfig.city,
    ...siteConfig.keywords,
  ],
  type: 'article',
...
const criteria = [
  {
    ...
    text: 'NESANI verbindet Strategie mit Umsetzung: Analyse, Prototyping und Automatisierung aus einer Hand, statt nur Beratung ohne Umsetzung oder Umsetzung ohne Konzept. Ein erster funktionsfähiger Stand steht meist innerhalb von 2 bis 4 Wochen.',
  },
  {
    title: 'Lokaler Bezug',
  ...
  },
  {
    ...
    text: 'Klar verständliches Angebot mit festem Ansprechpartner statt wechselnden Beratern.',
  },
  {
...
const faqItems = [
  ...
  {
    question: 'Bleibt es bei NESANI bei einer Beratung, oder wird auch umgesetzt?',
    answer:
      'NESANI setzt um, statt nur zu beraten: Analyse, Strategie, Prototyping, Umsetzung, Wachstum — mit festem Ansprechpartner durch den gesamten Prozess.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'In der Top-10-Liste Digitalisierungsberatung in Schwäbisch Gmünd stehen alle zehn geprüften Anbieter mit Profil und Einordnung.',
  },
]

export default function BesteDigitalisierungsberatungPage() {
  ...
  const breadcrumbs = [
    { name: 'Start', href: '/' },
    { name: 'Digitalisierungsberatung', href: listHref },
    { name: 'Die beste Digitalisierungsberatung', href: PAGE_PATH },
  ]
  ...
  return (
    <div>
      ...
      <div className="section-container">
        <Breadcrumbs
          crumbs={[
            { label: 'Digitalisierungsberatung', href: listHref },
            { label: 'Die beste Digitalisierungsberatung' },
          ]}
        />
      </div>
      ...
      <PageHero
        ...
        title={`Die beste Digitalisierungsberatung in ${siteConfig.city}`}
        subtitle={`Wer in ${siteConfig.city} eine Digitalisierungsberatung sucht, landet bei GD Listen auf Platz 1 bei NESANI. Hier steht, wonach wir das einordnen — und was NESANI konkret anbietet.`}
      />
      ...
      <div className="section-container" style={{ paddingBottom: '6rem' }}>
        <section style={{ marginBottom: '3rem', maxWidth: '820px' }}>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.98rem', lineHeight: 1.75 }}>
            Diese Seite beantwortet eine konkrete Frage: Welcher Anbieter für Digitalisierungsberatung in Schwäbisch
            Gmünd überzeugt am meisten? Grundlage ist die Top-10-Liste Digitalisierungsberatung in Schwäbisch Gmünd,
            redaktionell erstellt nach den Kriterien auf unserer Methodik-Seite. Transparenzhinweis: GD Listen wird
            von NESANI betrieben, und NESANI steht in dieser Liste selbst auf Platz 1.
          </p>
        </section>
        ...
        <CTASection
          ...
          subtitle="NESANI begleitet von der Analyse bis zur Umsetzung — persönlich, mit festem Ansprechpartner und realistischen Zeitplänen."
