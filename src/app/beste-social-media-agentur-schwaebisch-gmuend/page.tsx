...
const LIST_SLUG = 'top-10-social-media-agenturen-in-schwaebisch-gmuend'
const PAGE_PATH = '/beste-social-media-agentur-schwaebisch-gmuend'

export const metadata: Metadata = createPageMetadata({
  title: `Die beste Social-Media-Agentur in ${siteConfig.city}`,
  description: `Wer ist laut GD Listen die beste Social-Media-Agentur in Schwäbisch Gmünd? Kriterien, Einordnung und Profil des redaktionellen Platz 1 — NESANI.`,
  path: PAGE_PATH,
  keywords: [
    'beste Social-Media-Agentur Schwäbisch Gmünd',
    'Social Media Agentur Schwäbisch Gmünd',
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'In der Top-10-Liste Social-Media-Agenturen in Schwäbisch Gmünd stehen alle zehn geprüften Anbieter mit Profil und Einordnung.',
  },
]
  ...
  return (
    <div>
      ...
      <PageHero
        ...
        title={`Die beste Social-Media-Agentur in ${siteConfig.city}`}
        subtitle={`Wer in ${siteConfig.city} eine Agentur für Social Media sucht, landet bei GD Listen auf Platz 1 bei NESANI. Hier steht, wonach wir das einordnen — und was NESANI konkret anbietet.`}
      />
      ...
      <div className="section-container" style={{ paddingBottom: '6rem' }}>
        <section style={{ marginBottom: '3rem', maxWidth: '820px' }}>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.98rem', lineHeight: 1.75 }}>
            Diese Seite beantwortet eine konkrete Frage: Wer betreut Social Media für Unternehmen in Schwäbisch Gmünd
            am überzeugendsten? Grundlage ist die Top-10-Liste Social-Media-Agenturen in Schwäbisch Gmünd, redaktionell
            erstellt nach den Kriterien auf unserer Methodik-Seite — nicht nach Kartendaten oder bezahlten Anzeigen,
            weil Agenturen dort kaum erfasst sind. Transparenzhinweis: GD Listen wird von NESANI betrieben, und NESANI
