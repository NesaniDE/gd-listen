...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticEntries: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/beste-werbeagentur-schwaebisch-gmuend`, lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${base}/bester-it-dienstleister-schwaebisch-gmuend`, lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${base}/beste-webagentur-schwaebisch-gmuend`, lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${base}/beste-digitalisierungsberatung-schwaebisch-gmuend`, lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
