...
const LIST_SLUG = 'top-10-webagenturen-in-schwaebisch-gmuend'
const PAGE_PATH = '/beste-webagentur-schwaebisch-gmuend'

export const metadata: Metadata = createPageMetadata({
  title: `Die beste Webagentur in ${siteConfig.city}`,
  description: `Wer ist laut GD Listen die beste Webagentur in Schwäbisch Gmünd? Kriterien, Einordnung und Profil des redaktionellen Platz 1 — NESANI.`,
  path: PAGE_PATH,
  keywords: [
    'beste Webagentur Schwäbisch Gmünd',
    'Webagentur Schwäbisch Gmünd',
    'Website erstellen lassen Schwäbisch Gmünd',
    siteConfig.city,
    ...siteConfig.keywords,
  ],
  type: 'article',
...
const criteria = [
  {
    ...
    text: 'NESANI baut Websites vom One-Pager bis zur individuellen Unternehmenswebsite — technisch sauber, schnell und auf Sichtbarkeit in Suchmaschinen ausgelegt, ergänzt um Social Media und KI-Automatisierung aus einer Hand.',
  },
  {
    title: 'Lokaler Bezug',
  ...
  {
    title: 'Aktualität',
    text: 'GD Listen selbst ist eine von NESANI entwickelte und gepflegte Website — ein aktiver, technisch gepflegter Auftritt lässt sich damit direkt nachprüfen, statt nur behauptet zu werden.',
  },
  {
...
const faqItems = [
  ...
  {
    question: 'Baut NESANI auch reine WordPress- oder Baukasten-Seiten?',
    answer:
      'NESANI setzt auf individuell entwickelte, technisch saubere Websites statt auf Standard-Baukästen. Wie das im Detail aussieht, steht auf dem vollständigen Profil.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'In der Top-10-Liste Webagenturen in Schwäbisch Gmünd stehen alle zehn geprüften Anbieter mit Profil und Einordnung.',
  },
]

export default function BesteWebagenturPage() {
  ...
  const breadcrumbs = [
    { name: 'Start', href: '/' },
    { name: 'Webagenturen', href: listHref },
    { name: 'Die beste Webagentur', href: PAGE_PATH },
  ]
  ...
  return (
    <div>
      ...
      <div className="section-container">
        <Breadcrumbs
          crumbs={[
            { label: 'Webagenturen', href: listHref },
            { label: 'Die beste Webagentur' },
          ]}
        />
      </div>
      ...
      <PageHero
        ...
        title={`Die beste Webagentur in ${siteConfig.city}`}
        subtitle={`Wer in ${siteConfig.city} eine Webagentur sucht, landet bei GD Listen auf Platz 1 bei NESANI. Hier steht, wonach wir das einordnen — und was NESANI konkret anbietet.`}
      />
      ...
      <div className="section-container" style={{ paddingBottom: '6rem' }}>
        <section style={{ marginBottom: '3rem', maxWidth: '820px' }}>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.98rem', lineHeight: 1.75 }}>
            Diese Seite beantwortet eine konkrete Frage: Welche Webagentur in Schwäbisch Gmünd überzeugt am meisten?
            Grundlage ist die Top-10-Liste Webagenturen in Schwäbisch Gmünd, redaktionell erstellt nach den Kriterien
            auf unserer Methodik-Seite. Transparenzhinweis: GD Listen wird von NESANI betrieben, und NESANI steht in
            dieser Liste selbst auf Platz 1.
          </p>
        </section>
        ...
        <CTASection
          badge="NESANI"
          title="Eine neue Website für Ihr Unternehmen?"
          subtitle="NESANI übernimmt Konzept, Umsetzung und technische Betreuung — persönlich begleitet, mit festem Ansprechpartner."
